...
public class ServerTickHandler {
	...
	public void onPlayerTick (PlayerTickEvent event){
		if (event.player.getCurrentArmor(0)!= null){
			...
			if(boots.getItem() == Items.diamond_boots || boots.getItem() == Items.iron_boots || boots.getItem() == Items.golden_boots || boots.getItem() == Items.chainmail_boots || boots.getItem() == Items.leather_boots ){
				int j = EnchantmentHelper.getEnchantmentLevel(Frostbite.speedBoost.effectId, boots);
				if (j > 0){
