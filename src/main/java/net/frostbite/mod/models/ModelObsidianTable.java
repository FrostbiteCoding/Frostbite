...
public class ModelObsidianTable extends ModelBase
{
  ...
  public ModelObsidianTable()
  {
    ...
    textureHeight = 32;
      ...
      legone = new ModelRenderer(this, 0, 20);
      legone.addBox(0F, 0F, 0F, 4, 8, 4);
      legone.setRotationPoint(4F, 16F, 4F);
      legone.setTextureSize(64, 32);
      legone.mirror = true;
      setRotation(legone, 0F, 0F, 0F);
      legtwo = new ModelRenderer(this, 16, 20);
      legtwo.addBox(0F, 0F, 0F, 4, 8, 4);
      legtwo.setRotationPoint(4F, 16F, -8F);
      legtwo.setTextureSize(64, 32);
      legtwo.mirror = true;
      setRotation(legtwo, 0F, 0F, 0F);
      legthree = new ModelRenderer(this, 32, 20);
      legthree.addBox(0F, 0F, 0F, 4, 8, 4);
      legthree.setRotationPoint(-8F, 16F, 4F);
      legthree.setTextureSize(64, 32);
      legthree.mirror = true;
      setRotation(legthree, 0F, 0F, 0F);
      legfour = new ModelRenderer(this, 48, 20);
      legfour.addBox(0F, 0F, 0F, 4, 8, 4);
      legfour.setRotationPoint(-8F, 16F, -8F);
