package net.frostbite.mod.container;

import net.frostbite.mod.Frostbite;
import net.frostbite.mod.crafting.WorkSurfaceCraftingManager;
...
public class ContainerWorkSurface extends Container {
	...
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != Frostbite.blockWorkSurface) {
			return false;
		}else{
