...
public class AlabasterOven extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconTop = iconRegister.registerIcon(Frostbite.modid + ":" + "AlabasterOvenTop");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, Frostbite.modInstance, Frostbite.guiIDAlabasterOven, world, x, y, z);
		}
		return true;
	}
	...
	public static void updateAlabasterOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, Frostbite.blockAlabasterOvenActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, Frostbite.blockAlabasterOvenIdle);
		}
