...
import net.frostbite.mod.models.ModelObsidianTable;
...
public class RenderObsidianTable extends TileEntitySpecialRenderer {
	 ...
	 private static final ResourceLocation texture = new ResourceLocation(Frostbite.modid + ":textures/Blocks_SpecialRender/ObsidianTable.png");
